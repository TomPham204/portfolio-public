  ...
  return (
    <div className="container">
      ...
      <section id="about-me">
        <h3>My details</h3>
        <PersonalDetails />
        <button id="down-arrow" onClick={() => toNextId("my-techstack")}>
          <img src={downArrow} alt="move to next section" width="40" />
        </button>
      </section>
      <section id="my-techstack">
        ...
        <button id="down-arrow" onClick={() => toNextId("techstack-revisit")}>
          <img src={downArrow} alt="move to next section" width="40" />
        </button>
      </section>
      ...
      {techstackScrolled ? (
        <section id="techstack-revisit" className="techstack-scrolled">
          ...
          <button id="down-arrow" onClick={() => toNextId("fake-final")}>
            <img src={downArrow} alt="move to next section" width="40" />
          </button>
        </section>
      ) : (
        <section id="techstack-revisit" className="techstack-not-scrolled">
          <HideDuring inverse>
            <button id="up-arrow" onClick={() => toNextId("my-techstack")}>
              <img src={downArrow} alt="move to next section" width="40" />
            </button>
          </HideDuring>
          <h3>
            Not enough techs? Try scrolling on the tech stack list and let the
            magic happens.
          </h3>
        </section>
      )}
      <section id="fake-final" className="final">
        <h3>So, the end? Not until I tell you how I built this site.</h3>
        <div>
