    ...
    <Wrapper>
      <div id="prepare">
        <button id="music-note" onClick={() => setIsMute(!isMute)}>
          {isMute ? (
            <img id="unmute" src={musicMute} alt="music note" width="30" />
          ) : (
            <img id="mute" src={musicNote} alt="music note" width="30" />
          )}
        </button>
        {showArrow && (
          <img id="arrow" src={arrow} alt="arrow pointing to mute button" />
        )}
